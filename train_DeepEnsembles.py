...
def main(architecture, DE_num, learning_rate, epochs, model_num, dataset):
    ...
    for _ in range(model_num):
        ...
        schedulers = [ReduceLROnPlateau(opt, 'min', patience=5) for opt in optimizers]

        trainAcc, trainLoss, testAcc, testLoss, auroc = DeepEnsambleTrain(
...
if __name__ == "__main__":
    ...
    parser.add_argument('--DE_num',        type=int,   default=5)
